-- ============================================
-- Giai đoạn 1: Core Features Schema
-- Comments, Attachments, Notifications, Labels, Pagination
-- ============================================
...
-- Insert sample labels for existing projects
DO $$
DECLARE
